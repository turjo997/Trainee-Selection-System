...
// const Notice = () => {
//   const jobCirculars = ['Java', 'SQA', 'IOS'];
//   const examCategories = ['Written Test', 'Technical Test', 'HR-Interview'];
...
//     // Implement the logic to send the notice data to the backend using Axios or Fetch API
//     // You can use the selectedJobCircular, selectedExamCategory, title, and description here
//     // After saving the notice, you can show a success message to the user or close the popup
//     // You may also consider clearing the input fields after saving the notice
//     console.log({
//       jobCircular: selectedJobCircular,
...
//             <option key={jobCircular} value={jobCircular}>
//               {jobCircular}
//             </option>
//           ))}
//         </select>
