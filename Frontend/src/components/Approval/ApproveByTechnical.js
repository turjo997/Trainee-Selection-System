...
//       const response = await axios.post('http://localhost:8082/admin/approve/exam/{userId}/{circularId}/{examId}', data);
...
//           {examCategories.filter(examCategory => examCategory.examId === 1).map((examCategory) => (
...
//export default ApproveByTechnical;
